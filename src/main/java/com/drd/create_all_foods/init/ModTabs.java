    ...
    public static final RegistryObject<CreativeModeTab> TUTORIAL_TAB = TABS.register("tutorial_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(AllItems.SWEET_ROLL.get()))
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModItems.CARAMEL_GLAZED_CASHEW.get());
                        pOutput.accept(ModItems.WHITE_CHOCOLATE_GLAZED_WALNUT.get());
                        pOutput.accept(ModItems.BLACK_CHOCOLATE_GLAZED_WALNUT.get());
                        pOutput.accept(ModItems.RUBY_CHOCOLATE_GLAZED_WALNUT.get());
                        pOutput.accept(ModItems.CARAMEL_GLAZED_WALNUT.get());
                        pOutput.accept(ModItems.WHITE_CHOCOLATE_GLAZED_ALMOND.get());
                        pOutput.accept(ModItems.BLACK_CHOCOLATE_GLAZED_ALMOND.get());
                        pOutput.accept(ModItems.RUBY_CHOCOLATE_GLAZED_ALMOND.get());
                        pOutput.accept(ModItems.CARAMEL_GLAZED_ALMOND.get());
                        pOutput.accept(ModItems.WHITE_CHOCOLATE_GLAZED_PECAN.get());
                        pOutput.accept(ModItems.BLACK_CHOCOLATE_GLAZED_PECAN.get());
                        pOutput.accept(ModItems.RUBY_CHOCOLATE_GLAZED_PECAN.get());
                        pOutput.accept(ModItems.CARAMEL_GLAZED_PECAN.get());
                        pOutput.accept(ModItems.WHITE_CHOCOLATE_GLAZED_PISTACHIO.get());
                        pOutput.accept(ModItems.BLACK_CHOCOLATE_GLAZED_PISTACHIO.get());
                        pOutput.accept(ModItems.RUBY_CHOCOLATE_GLAZED_PISTACHIO.get());
                        pOutput.accept(ModItems.CARAMEL_GLAZED_PISTACHIO.get());
                        pOutput.accept(ModItems.WHITE_CHOCOLATE_GLAZED_MACADAMIA.get());
                        pOutput.accept(ModItems.BLACK_CHOCOLATE_GLAZED_MACADAMIA.get());
                        pOutput.accept(ModItems.RUBY_CHOCOLATE_GLAZED_MACADAMIA.get());
                        pOutput.accept(ModItems.CARAMEL_GLAZED_MACADAMIA.get());
                        pOutput.accept(ModItems.WHITE_CHOCOLATE_GLAZED_HAZELNUT.get());
                        pOutput.accept(ModItems.BLACK_CHOCOLATE_GLAZED_HAZELNUT.get());
                        pOutput.accept(ModItems.RUBY_CHOCOLATE_GLAZED_HAZELNUT.get());
                        pOutput.accept(ModItems.CARAMEL_GLAZED_HAZELNUT.get());
                        pOutput.accept(ModItems.WHITE_CHOCOLATE_GLAZED_PEANUT.get());
                        pOutput.accept(ModItems.BLACK_CHOCOLATE_GLAZED_PEANUT.get());
                        pOutput.accept(ModItems.RUBY_CHOCOLATE_GLAZED_PEANUT.get());
                        pOutput.accept(ModItems.CARAMEL_GLAZED_PEANUT.get());
                        pOutput.accept(ModItems.WHITE_CHOCOLATE_GLAZED_CHESTNUT.get());
                        pOutput.accept(ModItems.BLACK_CHOCOLATE_GLAZED_CHESTNUT.get());
                        pOutput.accept(ModItems.RUBY_CHOCOLATE_GLAZED_CHESTNUT.get());
                        pOutput.accept(ModItems.CARAMEL_GLAZED_CHESTNUT.get());
                        pOutput.accept(ModItems.WHITE_CHOCOLATE_GLAZED_NUT_MIX.get());
                        pOutput.accept(ModItems.BLACK_CHOCOLATE_GLAZED_NUT_MIX.get());
                        pOutput.accept(ModItems.RUBY_CHOCOLATE_GLAZED_NUT_MIX.get());
                        pOutput.accept(ModItems.CARAMEL_GLAZED_NUT_MIX.get());
