...
public class WhiteChocolateGlazedNutMixFoodItem extends Item {
    public WhiteChocolateGlazedNutMixFoodItem(Properties properties) {
        super(properties.food(ModCreateConfectioneryFoods.WHITE_CHOCOLATE_GLAZED_NUT_MIX).stacksTo(16));
    }
