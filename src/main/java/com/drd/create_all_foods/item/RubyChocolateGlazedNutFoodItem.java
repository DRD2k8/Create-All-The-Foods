...
public class RubyChocolateGlazedNutFoodItem extends Item {
    public RubyChocolateGlazedNutFoodItem(Properties properties) {
        super(properties.food(ModCreateConfectioneryFoods.RUBY_CHOCOLATE_GLAZED_NUT));
    }
