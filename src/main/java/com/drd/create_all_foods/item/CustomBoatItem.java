...
public class CustomBoatItem extends Item {
    ...
    public CustomBoatItem(boolean pHasChest, CustomBoat.Type pType, Item.Properties pProperties) {
        super(pProperties);
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
            ...
            if (hitresult.getType() == HitResult.Type.BLOCK) {
                ...
                if(boat instanceof CustomChestBoat chestBoat) {
                    chestBoat.setVariant(this.type);
                } else if(boat instanceof CustomBoat) {
                    ((CustomBoat)boat).setVariant(this.type);
                }
    ...
    private Boat getBoat(Level p_220017_, HitResult p_220018_) {
        return (Boat)(this.hasChest ? new CustomChestBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z) :
                new CustomBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z));
    }
}
