package com.drd.create_all_foods.entity;

import com.drd.create_all_foods.init.ModEntities;
...
public class CustomChestBoat extends ChestBoat {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, CustomBoat.Type.CINNAMON.ordinal());
    }
